            ...
            <div className="container mx-auto">
                ...
                <div className="hidden lg:flex lg:items-start lg:justify-between lg:gap-16">
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <button className="bg-[#FDC0C5] hover:cursor-pointer hover:bg-[#FDC0C5]/30 text-black font-medium px-16 py-8 rounded-full text-2xl transition-colors">
                            Visit Portfolio
                        </button>
                    </div>
                ...
                <div className="lg:hidden text-center space-y-8">
                    ...
                    <button className="bg-pink-300 hover:bg-pink-400 text-black font-medium px-8 py-4 rounded-full transition-colors">
                        Visit Portfolio
                    </button>
                </div>
            </div>
