                ...
                <div className="grid lg:grid-cols-3 gap-8 xl:gap-32 items-start">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="lg:flex hidden space-x-2 items-center justify-center"
                        >
                            {/* Instagram Icon */}
                            <motion.div whileHover={{ scale: 1.1 }} className="lg:w-10 lg:h-10 w-7 h-7 rounded flex items-center justify-center">
