        ...
        <section className="py-16 px-4 bg-white">
            <div className="container mx-auto">
                ...
                <div className="text-center mb-8 lg:mb-16">
                    ...
                    <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-[50px] xl:text-[70px] font-bold text-black mb-4 lg:mt-20">
                        Who Is <span className="text-[#FDC0C5]">Saleh Bilal?</span>
                    </h1>

                    <p className="text-[#1E1E1E] font-normal text-xs sm:text-sm md:text-base lg:text-xl xl:text-2xl -mt-2">Words That Drive Success.</p>
                </div>

                {/* Main Content */}
                <div className="grid xl:grid-cols-3 lg:gap-32 items-start">
                    ...
                    <div className="flex flex-col items-center xl:items-center">
                        ...
                        <div className="lg:flex hidden space-x-2 items-center justify-center">
                            ...
                            <div className="lg:w-10 lg:h-10 w-7 h-7 rounded flex items-center justify-center">
                    ...
                    <div className="text-center lg:text-left xl:col-span-2">
                        <h3 className="text-3xl lg:text-4xl xl:text-[40px] font-bold text-black mb-8">Hey, I'm Saleh</h3>

                        <div className="space-y-6 text-black px-10 lg:px-0 tracking-normal text-base md:text-xl 2xl:text-2xl font-medium leading-5 lg:leading-relaxed">
                            <p>
                ...
                {/* Mobile Social Icons - Only visible on mobile when content is stacked */}
