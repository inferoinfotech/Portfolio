      ...
      <div className="max-w-container mx-auto">
        ...
        >
          <div className="flex items-center justify-center mb-3 lg:mb-4">
            ...
            <h2 className="text-xs sm:text-sm md:text-base lg:text-lg font-medium tracking-[5] lg:tracking-[10] uppercase text-black">
              ABOUT ME
            </h2>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 xl:gap-32 items-start">
          ...
          >
            ...
            <motion.div
              variants={scaleUp}
              className="w-60 h-60 md:w-80 md:h-80 lg:w-80 lg:h-80 xl:w-[350px] xl:h-[350px] 2xl:w-[350px] 2xl:h-[350px]  rounded-full mb-8 flex items-center justify-center shrink-0"
            >
              <img
            ...
            >
              ...
              <motion.div
                ...
                className="lg:w-10 lg:h-10 w-6 h-6 rounded flex items-center justify-center"
              >
                <svg
          ...
          >
            ...
            >
              <motion.p variants={fadeUp}>
                I’m a top-ranked copywriter, social strategist, and digital
                marketer with over a decade of experience helping brands grow
                through the power of words.
              </motion.p>
              <motion.p variants={fadeUp}>
                Ranked #1 in Writing on Freelancer with over 600 successful
                projects and trusted by 14,000+ followers on LinkedIn, I’ve
                built a reputation for writing that cuts through the noise and
                drives real results.
              </motion.p>

              <motion.p variants={fadeUp}>
                I blend sharp copy, SEO know-how, and data-backed strategies to
                elevate brand visibility, spark engagement, and move audiences
                to action across websites, social media, and beyond. From
                scroll-stopping social posts to high-converting campaigns, I
                create content that connects and performs.
              </motion.p>

              <motion.p variants={fadeUp}>
                If you’re ready to grow smarter and faster, let’s make it
                happen.
              </motion.p>
            </motion.div>
          </motion.div>
