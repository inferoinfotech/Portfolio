    ...
    <section className="w-full bg-black py-8 md:py-12 lg:py-16">
      <div className="w-full px-4 md:px-6">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="md:hidden overflow-x-auto">
            <div className="flex gap-2 pb-4">
              {images.map((image, index) => (
                <div key={index} className="flex-shrink-0 w-48 h-48 sm:w-64 sm:h-64 rounded-xl overflow-hidden">
                  <img src={image.src || "/placeholder.svg"} alt={image.alt} className="w-full h-full object-cover" />
                </div>
              ))}
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          <p className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[48px] leading-tight md:leading-[60px] tracking-[-0.03em] text-white mb-6 md:mb-8">
          ...
          <p className="text-[#FDC0C5] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[48px] leading-tight md:leading-[60px] tracking-[-0.03em] mb-6 md:mb-8">
            Fortune's cover article named him the "CEO Whisperer."
          </p>

          <p className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[48px] leading-tight md:leading-[60px] tracking-[-0.03em] text-white">
