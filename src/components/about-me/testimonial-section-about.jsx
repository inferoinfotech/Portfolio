      ...
      <div className="w-full px-4 md:px-6">
        ...
        <div className="mb-8 md:mb-16 xl:mb-32">
          ...
          <div className="hidden md:grid md:grid-cols-5 gap-2 lg:gap-3">
            {images.map((image, index) => (
              <div key={index} className="rounded-[30px] overflow-hidden aspect-square">
        ...
        <div className="hidden md:block">
          <div className=" flex justify-center mb-8 md:mb-12 lg:mb-20">
            <div className="bg-black border-2 border-white rounded-[20px] px-3 md:px-4 py-2 flex items-center space-x-2">
