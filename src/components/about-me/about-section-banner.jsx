      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20 pt-3 lg:pt-0">
        ...
        >
          ...
          >
            ...
            <motion.h1 
              ...
              className="font-bold text-4xl sm:text-5xl md:text-6xl leading-[100%] tracking-[0] mb-6 md:mb-8"
            >
              <motion.span 
                variants={fadeUp}
        ...
        >
          ...
          >
            <motion.div 
              variants={fadeUp}
              className="mb-6 lg:mb-8 xl:mb-12"
            >
              <motion.div 
                variants={fadeUp}
              ...
              <motion.h1 
                variants={fadeUp}
                transition={{ delay: 0.2 }}
                className="font-bold text-5xl lg:text-6xl xl:text-7xl 2xl:text-[120px] tracking-[0]"
              >
                <motion.span 
                  variants={fadeUp}
                  transition={{ delay: 0.3 }}
            ...
            <motion.p 
              variants={fadeUp}
              transition={{ delay: 0.4 }}
              className="font-normal text-lg lg:text-xl xl:text-2xl 2xl:text-[32px] lg:pr-16 leading-relaxed lg:leading-[1.4] xl:leading-[45px] tracking-[0] text-white/80"
            >
              Pirate ipsum arrgh bounty warp jack. Sails ensign cup ballast spyglass execution lateen nipperkin
              american. Man spot line prey schooner no shiver brace weigh. Fer fleet yard chandler roger coxswain swab
              rig boatswain yarr.
