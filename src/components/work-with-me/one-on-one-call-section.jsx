...
export default function OneOnOneCallSection() {
  ...
  return (
    <motion.section 
      className="w-full bg-black py-12 md:py-16 lg:py-20 xl:py-24"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
      variants={fadeIn}
    >
      <div className="container mx-auto px-4 md:px-8 2xl:px-0">
        ...
        >
          <motion.h2 
            className="text-white font-bold text-4xl md:text-4xl lg:text-5xl xl:text-[64px] leading-tight sm:leading-tight md:leading-[110%] lg:leading-[100%] tracking-tight md:tracking-[-1%] lg:tracking-[-2%] text-center"
            variants={fadeUp}
          >
        ...
        {/* Call Items */}
        <motion.div 
          className="space-y-10 md:space-y-20 lg:space-y-24 xl:space-y-32"
          ...
          {callItems.map((item, index) => (
            ...
            >
              ...
              >
                ...
                >
                  <motion.span 
                    className="text-[64px] font-bold text-white/50 block mb-1 md:mb-4 text-center lg:text-left"
                    variants={fadeUp}
                  >
                    {item.number}
                  </motion.span>
                  <motion.p 
                    className="text-white/50 text-[24px] md:text-3xl leading-[100%] tracking-[-0.02em] text-center lg:text-left"
                    variants={fadeUp}
                ...
                >
                  <motion.h3 
                    className="text-white text-[24px] md:text-3xl xl:text-5xl font-bold mb-6 md:mb-6 leading-9 md:leading-16 tracking-[-0.02em] text-center lg:text-left"
                    variants={fadeUp}
                  ...
                  {/* Points */}
                  <motion.ul 
                    className="space-y-3 mb-6 sm:mb-7 md:mb-8 list-disc list-outside text-white text-justify lg:pl-5"
                    variants={staggerContainer}
                  >
                ...
                <motion.div variants={fadeUp}>
                  ...
                  <motion.button 
                    className="bg-white w-full sm:hidden text-black sm:bg-[#FDC0C5] sm:hover:bg-[#f8a8b0] sm:text-black cursor-pointer px-7 py-4 md:px-8 md:py-4 lg:px-10 lg:py-4 xl:px-12 xl:py-5 rounded-[20px] md:rounded-[50px] font-medium text-[20px] md:text-lg lg:text-xl xl:text-[22px] tracking-tight transition-colors duration-300 mt-2 lg:mt-10"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Book a free call
