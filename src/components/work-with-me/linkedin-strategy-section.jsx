    ...
    <section className="w-full bg-white py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <h2 className="font-bold text-[64px] leading-[100%] tracking-[-2%] text-black mb-12">
            I will be telling you the exact strategy
            <br />I used to grow my LinkedIn audience
          </h2>
          <p className="font-medium text-[32px] leading-[100%] tracking-[-2%] text-center text-black/70">Check out what people say after a 1-on-1 session with me on call</p>
        </div>
