        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex items-center">
            <div className="w-full bg-[linear-gradient(359.36deg,_#000000_31.78%,_#666666_130.09%)] rounded-[30px] p-6 md:p-12 text-white h-full">
              <h3 className="font-bold text-4xl md:text-[40px] leading-tight tracking-tight text-center mb-8 md:mb-10">
              ...
              <div className="space-y-3 md:space-y-4 mb-6 md:mb-10">
                {["1-on-1 session", "Free of cost", "30 min", "Discounted rates"].map((text, i) => (
                  <div key={i} className="flex items-center">
                    <SquareCheckBig className="w-6 h-6 md:w-8 md:h-8 lg:w-[36px] lg:h-[36px] text-white/80 mr-3 md:mr-4 lg:mr-6 mb-[30px] flex-shrink-0" />
                    <span className="text-2xl text-white/80 md:text-[32px] mb-[30px] font-normal">{text}</span>
                  </div>
                ))}
              </div>

              <div className="space-y-3 text-center">
                <button className=" text-center px-24 cursor-pointer bg-[#272727] text-white py-3 text-[16px] md:text-2xl rounded-[20px] font-normal hover:bg-[#333] transition-colors">
