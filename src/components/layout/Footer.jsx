...
export default function Footer() {
  return (
    <motion.footer
      ...
      viewport={{ once: true }}
      variants={fadeIn}
      className="bg-black text-white px-3 md:px-5 2xl:px-0 lg:border-t border-[#292929]"
    >
      <div className="container mx-auto py-12 lg:pt-12 lg:pb-5">
        ...
        >
          ...
          >
            ...
            <motion.h3
              ...
              className="text-2xl sm:text-3xl md:text-4xl lg:text-[32px] font-bold mb-5 text-[#FDC0C5]"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-[32px] font-normal text-[#979797] mb-8 leading-9"
            >
          ...
          >
            <motion.h3
              variants={fadeUp}
              className="text-xl sm:text-2xl lg:text-[32px] font-bold mb-4"
            >
            ...
            <motion.p
              ...
              className="text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mt-8 tracking-widest leading-10"
            >
        ...
        <motion.div
          variants={staggerContainer}
          className="lg:hidden px-3 space-y-8"
        >
          {/* Newsletter Section */}
          <motion.div variants={fadeUp}>
            <motion.h3 variants={fadeUp} className="text-2xl font-bold mb-2 text-white">
              Become an Expert now
            </motion.h3>
            <motion.p variants={fadeUp} className="text-white mb-6 leading-5">
              Sign up for exclusive content, emails & things Saleh doesn't share anywhere else
            </motion.p>
          ...
          <motion.div variants={fadeUp}>
            {/* Logo */}
            <motion.h2 variants={fadeUp} className="text-base font-bold text-white">
              SB
            </motion.h2>
            {/* Tagline */}
            <motion.h3 variants={fadeUp} className="text-xl font-bold mb-4 text-[#FDC0C5]">
              Work Less. Earn More. Enjoy Life
            </motion.h3>

            {/* Description */}
            <motion.p variants={fadeUp} className="text-[#979797] leading-5 mb-6">
              I dive deep into human potential, lifestyle design, and one person businesses to give you a unique,
              digestible way of improving your life.
            </motion.p>
        ...
        <motion.div
          variants={fadeUp}
          className="lg:mt-12 lg:pt-4 pb-2 text-center hidden lg:block"
        >
