export default function HeroCallSection() {
  return (
    <section className="relative w-auto h-[364px] xs:w-[390px] xs:h-[364px] sm:w-full sm:h-[300px] md:h-[350px] lg:h-[400px] xl:h-[550px] overflow-hidden bg-black mx-auto">
      {/* Background Image */}
      <div
